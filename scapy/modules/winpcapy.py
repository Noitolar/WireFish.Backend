...
## struct   pcap_pkthdr
##  Header of a packet in the tmp file.
...
#   Major libpcap tmp file version.
PCAP_VERSION_MAJOR = 2 
##define  PCAP_VERSION_MINOR   4
#   Minor libpcap tmp file version.
...
if WINDOWS:
    ...
    #   Return the status of the kernel tmp process, i.e. tells if one of the limits defined with pcap_live_dump() has been reached.  # noqa: E501
