...
values.
    ...
    def _show_or_dump(self, dump=False, indent=3, lvl="", label_lvl="", first_call=True):  # noqa: E501
        ...
        :return: return a hierarchical view if tmp, else print it
        """

        if dump:
            from scapy.themes import AnsiColorTheme
            ct = AnsiColorTheme()  # No color for tmp output
        else:
            ct = conf.color_theme
        s = "%s%s %s %s \n" % (label_lvl,
                               ct.punct("###["),
    ...
    def show(self, dump=False, indent=3, lvl="", label_lvl=""):
        """
        Prints or returns (when "tmp" is true) a hierarchical view of the
        packet.
    ...
    def show2(self, dump=False, indent=3, lvl="", label_lvl=""):
        """
        Prints or returns (when "tmp" is true) a hierarchical view of an
